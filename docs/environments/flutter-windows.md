...
It intentionally does not invoke Flutter during the artifact-level verification because Flutter command execution may initialize cache state. CLI-level environment smoke verification remains a separate integration concern.
